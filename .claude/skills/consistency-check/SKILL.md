...
- マイルストーンのチケット一覧に記載された全チケットに requirements ファイルが存在するか
- 優先度の高いチケットから実装が進んでいるか
- マイルストーンのスコープ外の作業（マイルストーンに記載のないチケットの実装）が混入していないか
...
- [ ] マイルストーンが設定されている場合: チケットがマイルストーンのチケット一覧に含まれている
